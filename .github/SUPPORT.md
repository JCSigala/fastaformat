# Getting help with `fastaformat`

Thank you for using `fastaformat`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/fastaformat`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/fastaformat),
...
[search issues and pull requests](https://github.com/JCSigala/fastaformat/issues)
